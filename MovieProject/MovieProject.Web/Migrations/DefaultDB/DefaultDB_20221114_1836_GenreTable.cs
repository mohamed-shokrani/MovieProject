...
namespace MovieProject.Migrations.DefaultDB;
...
public class DefaultDB_20221114_1836_GenreTable :AutoReversingMigration
{
    ...
    {
        //Create.Table("Genre").WithColumn("GenreId").AsInt32().PrimaryKey().Identity()
        //    .WithColumn("Name").AsString().NotNullable();

        //Alter.Table("Movie").AddColumn("GenreId").AsInt32().NotNullable()
